export const appConfig = {
  ...
  importGmailTimeoutMs: Number(process.env.IMPORT_GMAIL_TIMEOUT_MS ?? '30000'),
  ...
  importTxnLabelParent: process.env.IMPORT_TXN_LABEL_PARENT ?? 'CC Transactions',
  importTxnGeminiBodyMaxLen: Number(process.env.IMPORT_TXN_GEMINI_BODY_MAX_LEN ?? '4000'),
  importTxnGeminiBatchSize: Number(process.env.IMPORT_TXN_GEMINI_BATCH_SIZE ?? '5'),
  importTxnGeminiBatchGapMs: Number(process.env.IMPORT_TXN_GEMINI_BATCH_GAP_MS ?? '60000'),
  importTxnFallbackStartDate: process.env.IMPORT_TXN_FALLBACK_START_DATE ?? '2026-03-01',
